...
export default {
    ...
    methods: {
      beforeEnter() {
        this.$gsap.set('.about__gallery__media', {
          opacity: 0
        })
      },

      enter() {
        this.$gsap.to('.about__gallery__media', {
          opacity: 1,
          duration: 2,
          ease: 'expo.out',
          stagger: 0.1
        ...
        this.$gsap.from(splitFirst.lines, {
          opacity: 0,
          y: 50,
          duration: 1.2,
          ease: 'expo.out',
      ...
      aboutContent() {
        ...
        contents.forEach( (element) => {
          const label = element.querySelector(".about__content__label")
          const description = element.querySelectorAll(".about__content__description")
          const image = element.querySelectorAll(".about__content__media")
          
          
          const tl = this.$gsap.timeline()
            .from(label, { opacity: 0,
              y: 50,
              duration: 0.8,
              ease: 'expo.out'})
